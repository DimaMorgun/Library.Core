...
var book_1 = __webpack_require__("./src/app/services/book.ts");
            ...
            providers: [
                {
                    ...
                    provide: book_1.BookService,
                    useFactory: function (jsonp) { return function () { return new book_1.BookService(jsonp); }; }
                }
            ],
...
var book_2 = __webpack_require__("./src/app/services/book.ts");
var BookComponent = /** @class */ (function () {
    ...
    BookComponent = __decorate([
        ...
        __param(0, core_1.Inject(book_2.BookService)),
...
var BookService = /** @class */ (function (_super) {
    ...
    BookService.prototype.fetch = function (action, data) {
        ...
        return this.http.get('http://localhost:57534/api/book').pipe(map_1.map(function (res) { return res; }));
        //return this.http
