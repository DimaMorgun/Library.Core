...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_book_service__ = __webpack_require__("./src/app/services/book.service.ts");
            ...
            providers: [
                {
                    ...
                    provide: __WEBPACK_IMPORTED_MODULE_10__services_book_service__["a" /* BookService */],
                    useFactory: function (jsonp) { return function () { return new __WEBPACK_IMPORTED_MODULE_10__services_book_service__["a" /* BookService */](jsonp); }; }
                }
            ],
...
var BookComponent = /** @class */ (function () {
    ...
    BookComponent = __decorate([
        ...
        __param(0, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Inject */])(__WEBPACK_IMPORTED_MODULE_4__services_book_service__["a" /* BookService */])),
...
var BookService = /** @class */ (function (_super) {
    ...
    BookService.prototype.read = function () {
        ...
        this.fetch()
            ...
            _super.prototype.next.call(_this, data.books);
        });
    };
    ...
    BookService.prototype.resetItem = function (dataItem) {
        ...
        var originalDataItem = this.data.books.find(function (item) { return item.bookId === dataItem.bookId; });
        // revert changes
        Object.assign(originalDataItem, dataItem);
        _super.prototype.next.call(this, this.data.books);
    };
